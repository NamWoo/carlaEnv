...
class BasicAgent(Agent):
    ...
    def _draw_waypoints(self, route):
        ...
        for (waypoint, _) in route:
            ...
            if waypoint.transform.location.x != lastx or waypoint.transform.location.y != lasty:
                self._vehicle.get_world().debug.draw_point(
                    waypoint.transform.location,
                    0.04, carla.Color(r=255, g=0, b=0), life_time=60.0)
